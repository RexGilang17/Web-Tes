        ...
        <section id="contact" class="contact">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="align-center" data-aos="fade-up" data-aos-delay="300">
                        <form action="form-daftar.php" method="POST" role="form">
                            ...
                            <br>
                            <div> <button class="btn btn-primary" type="submit" id="nim" name="daftar"
                                    value="simpan">Button</button>
                            </div>
        ...
        <section id="about" class="about">
            ...
            <table border="1" align="center">
                ...
                while ($siswa = mysqli_fetch_array($query)) {
                    ...
                    echo "<a href='form-delet.php?nim=" . $siswa['nim'] . "'>Hapus</a>    |";
                    echo "</td>";
                            ...
                            <div class="testimonial-wrap">
                                <div class="testimonial-item">
                                    <img src="assets/img/testimonials/testimonials-1.jpg" class="testimonial-img"
                                        alt="">
                                    <?php
                                    $sql = "SELECT * FROM mahasiswa where jurusan ='IT'";
                                    $query = mysqli_query($koneksi, $sql);
                                    while ($mhs = mysqli_fetch_array($query)) {
                                    ?>
                                    <?php echo "<h3>" . $mhs['nama_lengkap'] . "</h3>";
                                        echo "<h4>" . $mhs['jurusan'] . "</h4>"; ?>
                                    <p>
                                        <!--<i class="bx bxs-quote-alt-left quote-icon-left"></i>-->
                                        <?php echo "<h5>" . $mhs['tempat_lahir'] . "</h5>";
                                    } ?>
                            ...
                            <div class="testimonial-wrap">
                                <div class="testimonial-item">
                                    <img src="assets/img/testimonials/testimonials-2.jpg" class="testimonial-img"
                                        alt="">
                                    <?php
                                    $sql = "SELECT * FROM mahasiswa where jurusan ='MESIN'";
                                    $query = mysqli_query($koneksi, $sql);
                                    while ($mhs = mysqli_fetch_array($query)) {
                                    ?>
                                    <?php echo "<h3>" . $mhs['nama_lengkap'] . "</h3>";
                            ...
                            <div class="testimonial-wrap">
                                <div class="testimonial-item">
                                    <img src="assets/img/testimonials/testimonials-4.jpg" class="testimonial-img"
                                        alt="">
                                    <?php
                                    $sql = "SELECT * FROM mahasiswa where jurusan ='MULTIMEDIA'";
                                    $query = mysqli_query($koneksi, $sql);
                                    while ($mhs = mysqli_fetch_array($query)) {
                                    ?>
                                    <?php echo "<h3>" . $mhs['nama_lengkap'] . "</h3>";
